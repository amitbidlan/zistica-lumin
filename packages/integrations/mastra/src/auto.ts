/**
 * Side-effect entry point — `import "@lumin-io/mastra/auto"` enables
 ...
 * `luminConfig()` helper — see the package README. This module
...
// caller can re-invoke `installLuminTracing()` after their
// framework boots, or fall back to `luminConfig()`.
installLuminTracing();
